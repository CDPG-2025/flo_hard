...
class FlotillaServerManager:
    def __init__(self, server_config: dict):
        print("[FLOW] server_manager.py: Initializing FlotillaServerManager")
        ...
        self.mqtt_init_finish_event = Event()  # Use threading.Event for thread compatibility
        
        print("[FLOW] server_manager.py: Initializing MQTTManager")
    ...
    async def run(
        ...
        print("[FLOW] server_manager.py: Starting session")
        await session.start_session()
        print("[FLOW] server_manager.py: Session finished, renaming logs")

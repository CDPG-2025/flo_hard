...
echo "cd /home/snowden/Desktop/flotilla/src && python flo_server.py"
echo ""
echo "### Terminal 3: Start Client 1 ###"
echo "cd /home/snowden/Desktop/flotilla/src && python flo_client.py --client-num 1"
echo ""
echo "### Terminal 4: Start Client 2 ###"
echo "cd /home/snowden/Desktop/flotilla/src && python flo_client.py --client-num 2"
echo ""
echo "### Terminal 5: Start Training Session (Optional) ###"
echo "cd /home/snowden/Desktop/flotilla/src && python flo_session.py ../config/flotilla_quicksetup_config.yaml --federated_server_endpoint localhost:12345"
echo ""
echo "================================================"
